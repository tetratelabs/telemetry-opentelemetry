...
// To propagate a tag map to downstream methods and downstream RPCs, add a tag
// map to the current context. NewContext will return a copy of the current
// context, and put the tag map into the returned one.
