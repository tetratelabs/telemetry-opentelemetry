...
const (
	...
	// valueTTLUnlimitedPropagation allows tag to propagate without any limits
	// on number of hops.
...
// TODO: move TagMap.Mspec over to Telemetry repository.
type TTL struct {
	ttl int
}

var (
	// TTLUnlimitedPropagation is TTL metadata that allows tag to propagate
	// without any limits on number of hops.
